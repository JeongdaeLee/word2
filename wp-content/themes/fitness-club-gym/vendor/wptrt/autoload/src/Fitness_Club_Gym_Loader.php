...
class Fitness_Club_Gym_Loader {
	 ...
	 * @return void
	 */
	public function fitness_club_gym_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function fitness_club_gym_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function fitness_club_gym_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function fitness_club_gym_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->fitness_club_gym_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function fitness_club_gym_load( $class ) {
