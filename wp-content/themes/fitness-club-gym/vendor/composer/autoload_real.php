...
class Fitness_Club_Gym_ComposerAutoloaderInit75f95ca3778976eb5c1bf35fe42ac3d4
{
    private static $loader;

    public static function fitness_club_gym_loadClassLoader($class)
    {
    ...
    public static function fitness_club_gym_getLoader()
    {
        if (null !== self::$loader) {
            return self::$loader;
        }
